  ...
  return (
    <tr className="discapacidad-row">
      ...
      <td className="discapacidad-actions">
        <button className="discapacidades-editar-button" onClick={() => onEdit(discapacidad)}>Editar</button>
        <button className="discapacidades-eliminar-button" onClick={() => onDelete(discapacidad.id)}>Eliminar</button>
      </td>
    </tr>
  );
};
